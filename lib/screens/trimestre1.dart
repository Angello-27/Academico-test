...
class Trimestre1Screen extends StatefulWidget {
  const Trimestre1Screen({super.key});

  @override
  State<Trimestre1Screen> createState() => _Trimestre1Screen();
}
                        ...
                        setState(() {
                          ...
                          if (newValue == '3er Trimestre') {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const Trimestre3Screen()),
                            );
                          }
                          if (newValue == '1er Trimestre') {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const Trimestre1Screen()),
                            );
                          }
                          if (newValue == '2do Trimestre') {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const Trimestre2Screen()),
                            );
                          }
                        });
                      },
